  ...
  render(props) {
    return(
      <div className="box-body">
        ...
        { this.props.formSelectedOption === "SeqForm" ? <StructForm {...this.props} handleChange={this.props.handleSeqChange} handleReset={this.props.handleReset} handleSubmit={this.props.handleSubmit} /> : <StructForm  {...this.props} handleChange={this.props.handleStructChange} handleReset={this.props.handleReset} handleSubmit={this.props.handleSubmit} />}
